...
#USAGE: perl 7_stopgain_pop.pl GF11 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/DiagnoVarFilter/dignosis
...
open (TXTFILE, "$samplepath/processed_files/fam.$famname.stopgain");
#search file
open(my $outfile1, ">","$samplepath/processed_files/fam.$famname.stopgain.nfe");
open(my $outfile2, ">","$samplepath/processed_files/fam.$famname.stopgain.nfe.cnt");
