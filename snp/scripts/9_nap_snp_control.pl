...
#USAGE: perl 9_cases_snp_control.pl GF11 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/DiagnoVarFilter/dignosis
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.cases.con") or die "cannot open file fam.$famname.dam.nfe.sam.con";
