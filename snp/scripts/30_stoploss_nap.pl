...
#USAGE: perl 30_stoploss_cases.pl GF11 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/DiagnoVarFilter/dignosis
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.stoploss.cases") or die "cannot open file cases";
  ...
  open FILE2, "$samplepath/processed_files/fam.$famname.stoploss.cases.con" or die;
#
