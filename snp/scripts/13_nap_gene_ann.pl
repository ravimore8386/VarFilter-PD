...
#USAGE: perl 13_cases_gene_ann.pl GF11 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/DiagnoVarFilter/dignosis
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.cases.gene.res") or die "cannot open file";
...
open FILE99, "$samplepath/processed_files/fam.$famname.cases.out" or die;
#
