...
#USAGE: perl 12_cases_get_lines.pl GF11 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/DiagnoVarFilter/dignosis
...
open FILE1, "$samplepath/processed_files/fam.$famname.cases.cnt" or die "cannot open file";
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.cases.out");
...
open (TXTFILE, "$samplepath/processed_files/fam.$famname.cases") or die "cannot open file fam_n_com.vpr.dam";  #search file
