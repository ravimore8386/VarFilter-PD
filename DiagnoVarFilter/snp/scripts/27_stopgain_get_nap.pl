...
#USAGE: perl 27_stopgain_get_cases.pl GF11 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/DiagnoVarFilter/dignosis
...
open FILE, "$samplepath/processed_files/fam.$famname.stopgain.cases.cnt" or die "cannot open file fam.$famname.dam.nfe";
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.stopgain.cases.out");
...
open (TXTFILE, "$samplepath/processed_files/fam.$famname.stopgain.cases") or die "cannot open file ";  #search file
