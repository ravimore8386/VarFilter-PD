...
#USAGE: perl 25_stopgain_cases.pl GF11 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/DiagnoVarFilter/dignosis
...
# cases
open FILE1, "$samplepath/input_samples_details/input_cases.txt" or die "cannot open file cases.txt"; #search contorl file
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.stopgain.cases") or die "cannot open file cases";
...
open FILE2, "$samplepath/processed_files/fam.$famname.stopgain.cases.con" or die;
