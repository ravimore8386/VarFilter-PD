...
#USAGE: perl 28_stopgain_gene_ann_cases.pl GF11 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/DiagnoVarFilter/dignosis
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.stopgain.cases.gene.res") or die "cannot open file";
...
open FILE99, "$samplepath/processed_files/fam.$famname.stopgain.cases.out" or die;
