...
#USAGE: perl 13_nap_gene_ann.pl GF15 $samplepath/input_annovar_annotated_txt_files/dignosis
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.nap.gene.res") or die "cannot open file";
...
open FILE99, "$samplepath/processed_files/fam.$famname.nap.out" or die;
#
