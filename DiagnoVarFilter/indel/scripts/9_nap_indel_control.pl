...
#USAGE: perl 9_nap_snp_control.pl GF15 $samplepath/input_annovar_annotated_txt_files/dignosis
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.nap.con") or die "cannot open file fam.$famname.nap.con";
