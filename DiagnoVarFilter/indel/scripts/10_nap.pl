...
#USAGE: perl 10_nap.pl GF15 $samplepath/input_annovar_annotated_txt_files/dignosis
...
# nap
open FILE1, "$samplepath/input_samples_details/input_cases.txt" or die "cannot open file nap.txt"; #search contorl file
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.nap") or die "cannot open file nap";
