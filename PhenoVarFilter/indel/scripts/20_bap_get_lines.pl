...
#USAGE: perl 22_bap_get_lines.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/indel/het2

my $famname = $ARGV[0]; #GF18

my $samplepath = $ARGV[1];# "/mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/indel/het2";

open FILE1, "$samplepath/processed_files/fam.$famname.bap.cnt" or die "cannot open file ";
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.bap.out");
...
open (TXTFILE, "$samplepath/processed_files/fam.$famname.bap") or die "cannot open file";  #search file
