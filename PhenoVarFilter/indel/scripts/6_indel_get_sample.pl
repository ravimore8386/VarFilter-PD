#!/usr/bin/perl
#USAGE: perl 6_get_sample.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/indel/het2
...
open FILE1, "$samplepath/processed_files/fam.$famname.dam" or die "cannot open file fam.$famname.dam";
