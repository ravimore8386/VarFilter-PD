...
#USAGE: perl 12_nap_get_lines.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/indel/het2
...
open (TXTFILE, "$samplepath/processed_files/fam.$famname.nap") or die "cannot open file";  #search file
