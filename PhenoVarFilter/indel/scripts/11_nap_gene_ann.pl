...
#USAGE: perl 13_nap_gene_ann.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/indel/het2
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.nap.gene.res");
...
open FILE99, "$samplepath/processed_files/fam.$famname.nap.out"  or die "cannot open file";
