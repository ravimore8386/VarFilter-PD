...
open (TXTFILE, "$samplepath/processed_files/res.$famname.indel.het.out") or die "Cannot open the file $!";

open(my $outfile1, ">","$samplepath/processed_files/res.$famname.indel.het.dup.out");
...
open(my $outfile, ">","$samplepath/processed_files/res.$famname.indel.het.out.count");
