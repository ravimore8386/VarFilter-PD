...
#USAGE: perl 19_bap_indel_control.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/indel/het2
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.bap.con") or die "cannot open file fam.$famname.bap.con";
