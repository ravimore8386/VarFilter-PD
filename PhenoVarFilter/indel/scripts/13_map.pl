...
#USAGE: perl 15_map.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/indel/het2
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.map") or die "cannot open file nap";
...
open FILE, "$samplepath/processed_files/fam.$famname.map.con" or die;
