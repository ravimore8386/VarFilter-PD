...
#USAGE: perl 23_bap_gene_ann.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/indel/het2
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.bap.gene.res") or die "cannot open file";
...
open FILE99, "$samplepath/processed_files/fam.$famname.bap.out" or die;
