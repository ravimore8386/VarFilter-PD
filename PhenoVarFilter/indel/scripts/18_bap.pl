...
#USAGE: perl 20_bap.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/indel/het2
...
# MAP
open FILE2, "$samplepath/input_samples_details/input_map.txt" or die "cannot open file map.txt"; #search contorl file
...
# BAP
open FILE3, "$samplepath/input_samples_details/input_bap.txt" or die "cannot open file bap.txt"; #search contorl file
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.bap") or die "cannot open file nap";
...
open FILE, "$samplepath/processed_files/fam.$famname.bap.con" or die;
