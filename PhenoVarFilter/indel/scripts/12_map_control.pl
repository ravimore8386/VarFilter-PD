...
#USAGE: perl 14_map_indel_control.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/indel/het2
...
open FILE1, "$samplepath/input_annovar_annotated_txt_files/$item2.indel.txt" or die "cannot open file"; #search contorl file
...
open(my $outfile, ">","$samplepath/processed_files/fam.$famname.map.con") or die "cannot open file fam.$famname.map.con";
...
open FILE, "$samplepath/processed_files/fam.$famname.dam.nfe.sam" or die;
