...
#USAGE: perl 10_nap.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.nap") or die "cannot open file nap";
  ...
  open FILE2, "$working_dir/processed_files/ped.$pedigree.nap.con" or die;
