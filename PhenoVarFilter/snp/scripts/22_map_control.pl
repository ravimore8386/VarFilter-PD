...
#USAGE: perl 14_map_snp_control.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het
...
open FILE1, "$working_dir/input_annovar_annotated_txt_files/$item2.snp.txt" or die "cannot open file"; #search contorl file
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.map.con") or die "cannot open file fam.$pedigree.map.con";
