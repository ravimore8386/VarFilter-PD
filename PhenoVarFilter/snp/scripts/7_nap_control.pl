...
#USAGE: perl 9_nap_snp_control.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.nap.con") or die "cannot open file fam.$pedigree.dam.nfe.sam.con";
...
open FILE, "$working_dir/processed_files/ped.$pedigree.dam.nfe.sam" or die;
