...
#USAGE: perl 16_map_count.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het 3
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.map.cnt") or die "Cannot open the file $!";

#nap file
open FR,"$working_dir/processed_files/ped.$pedigree.map" || die("Cannot open the file $!");
