...
#USAGE: perl 26_stopgain_count_nap.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het 2
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.stopgain.nap.cnt") or die "Cannot open the file $!";

#nap file
open FR,"$working_dir/processed_files/ped.$pedigree.stopgain.nap" || die("Cannot open the file $!");
