...
#USAGE: perl 12_nap_get_lines.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het

my $pedigree = $ARGV[0]; #GF18

my $working_dir = $ARGV[1];# "/mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het";

open FILE1, "$working_dir/processed_files/ped.$pedigree.nap.cnt" or die "cannot open file";
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.nap.out");
...
open (TXTFILE, "$working_dir/processed_files/ped.$pedigree.nap") or die "cannot open file fam_n_com.vpr.dam";  #search file
