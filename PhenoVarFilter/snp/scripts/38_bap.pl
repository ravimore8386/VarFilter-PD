...
#USAGE: perl 20_bap.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.bap") or die "cannot open file nap";
...
open FILE, "$working_dir/processed_files/ped.$pedigree.bap.con" or die;
