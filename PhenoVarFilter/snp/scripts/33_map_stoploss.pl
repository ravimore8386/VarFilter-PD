...
#USAGE: perl 40_stoploss_map.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het
...
# NAP
open FILE1, "$working_dir/input_samples_details/input_nap.txt" or die "cannot open file"; #search contorl file
...
# mAP
open FILE2, "$working_dir/input_samples_details/input_map.txt" or die "cannot open file nap.txt"; #search contorl file
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.stoploss.map") or die "cannot open file nap";
...
open FILE, "$working_dir/processed_files/ped.$pedigree.stoploss.map.con" or die;
