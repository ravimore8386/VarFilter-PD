...
#USAGE: perl 49_stoploss_control_bap.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het 
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.stoploss.bap.con") or die "cannot open file fam.$pedigree.stoploss.nap.con";
...
open FILE1, "$working_dir/processed_files/ped.$pedigree.stoploss.nfe" or die;
