...
#USAGE: perl 34_stopgain_control_map.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het
...
my %hashcontrol;
open (TXTFILE1, "$working_dir/input_samples_details/input_control.txt");
my @control = <TXTFILE1>;
chomp(@control);
my $cont;
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.stopgain.map.con") or die "cannot open file";
