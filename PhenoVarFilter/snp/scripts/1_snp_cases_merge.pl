...
open(my $outfile, ">","$working_dir/processed_files/ped_n_com.vpr") or die "Cannot open the file $!";  #output

my @cases=();
open TXTFILE, "$working_dir/input_samples_details/input_all_cases.txt" or die "Cannot open the file $!"; #input
