...
#USAGE: perl 39_stoploss_control_map.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/$working_dir/F03.snp.txt
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.stoploss.map.con") or die "cannot open file fam.$pedigree.stoploss.nap.con";
...
open FILE2, "$working_dir/processed_files/ped.$pedigree.stoploss.nfe" or die;

while (my $line2=<FILE2>)
      {
      chomp($line2);
      my($b1,$b2,$b3,$b4,$b5,$b6,$b7) = split /\t/, $line2;
