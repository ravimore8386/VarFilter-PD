...
#USAGE: perl 46_stopgain_count_bap.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het 4
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.stopgain.bap.cnt") or die "Cannot open the file $!";

#bap
open FR,"$working_dir/processed_files/ped.$pedigree.stopgain.bap" || die("Cannot open the file $!");
