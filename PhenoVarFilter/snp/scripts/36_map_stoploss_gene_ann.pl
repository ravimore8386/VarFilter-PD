...
#USAGE: perl 43_stoploss_gene_ann_map.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.stoploss.map.gene.res") or die "cannot open file";
...
open FILE99, "$working_dir/processed_files/ped.$pedigree.stoploss.map.out" or die;
