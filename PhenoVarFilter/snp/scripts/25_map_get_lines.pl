...
#USAGE: perl 17_map_get_lines.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het

my $pedigree = $ARGV[0]; #GF18

my $working_dir = $ARGV[1];# "/mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het";

open FILE1, "$working_dir/processed_files/ped.$pedigree.map.cnt" or die "cannot open file";
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.map.out");
...
open (TXTFILE, "$working_dir/processed_files/ped.$pedigree.map") or die "cannot open file ";  #search file
