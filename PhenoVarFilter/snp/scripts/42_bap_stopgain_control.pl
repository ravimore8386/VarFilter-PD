...
#USAGE: perl 44_stopgain_control_bap.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het 
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.stopgain.bap.con") or die "cannot open file fam.$pedigree.stopgain.bap.con";
...
open FILE1, "$working_dir/processed_files/ped.$pedigree.stopgain.nfe" or die;
