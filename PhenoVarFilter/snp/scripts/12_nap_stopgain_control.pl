...
#USAGE: perl 24_stopgain_control_nap.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/$working_dir/F03.snp.txt
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.stopgain.nap.con") or die "cannot open file fam.$pedigree.stopgain.nap.con";
...
open FILE, "$working_dir/processed_files/ped.$pedigree.stopgain.nfe" or die;

 while (my $line3=<FILE>)

      {
      chomp($line3);
      my($b1,$b2,$b3,$b4,$b5,$b6,$b7) = split /\t/, $line3;
