...
#USAGE: perl 32_stoploss_get_nap.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het

my $pedigree = $ARGV[0]; #GF18

my $working_dir = $ARGV[1];# "/mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het";

open FILE, "$working_dir/processed_files/ped.$pedigree.stoploss.nap.cnt" or die "cannot open file fam.$pedigree.dam.nfe";
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.stoploss.nap.out");
...
open (TXTFILE, "$working_dir/processed_files/ped.$pedigree.stoploss.nap") or die "cannot open file fam_n_com.vpr.dam";  #search file
