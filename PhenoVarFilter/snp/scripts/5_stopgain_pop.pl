...
#USAGE: perl 7_stopgain_pop.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het
...
open (TXTFILE, "$working_dir/processed_files/ped.$pedigree.stopgain");
#search file
open(my $outfile1, ">","$working_dir/processed_files/ped.$pedigree.stopgain.nfe");
open(my $outfile2, ">","$working_dir/processed_files/ped.$pedigree.stopgain.nfe.cnt");
