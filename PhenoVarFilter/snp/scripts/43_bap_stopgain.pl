...
#USAGE: perl 45_stopgain_bap.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het
...
# BAP
open FILE3, "$working_dir/input_samples_details/input_bap.txt" or die "cannot open file bap.txt"; #search contorl file
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.stopgain.bap") or die "cannot open file nap";
...
open FILE, "$working_dir/processed_files/ped.$pedigree.stopgain.bap.con" or die;
