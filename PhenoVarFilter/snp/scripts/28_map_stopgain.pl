...
#USAGE: perl 35_stopgain_map.pl GF18 /mnt/b2/home4/arc/rm975/wgs/pedigree/GF18/variant_prio/snp/het
...
open(my $outfile, ">","$working_dir/processed_files/ped.$pedigree.stopgain.map") or die "cannot open file nap";
...
open FILE, "$working_dir/processed_files/ped.$pedigree.stopgain.map.con" or die;
